...
The Box-Ljung Test (p-value = 0.0031) rejects the null hypothesis of no serial correlation,
indicating the presence of serial correlation in the weekly log returns.
PACF Plot:
